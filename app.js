...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsCookie = __webpack_require__(219);

	var _jsCookie2 = _interopRequireDefault(_jsCookie);

	var _rules = __webpack_require__(217);
	...
	var bookRequest = fetch('./book.txt').then(function (r) {
	    return r.text();
	});
	var book = [];
	...
	var applyLetter = function applyLetter(letter) {
	    var element = getLetterElement(letter);
	    (typeof element === 'undefined' ? 'undefined' : _typeof(element)) === "object" ? pageEl.appendChild(getLetterElement(letter)) : pageEl.append(letter);
	};
	...
	var nextEvent = _kefir2.default.fromEvents(nextButton, "click").map(function () {
	    return 1;
	});
...
/***/ function(module, exports) {
	...
	var rusLetters = exports.rusLetters = {
	    "а": "#ec0000",
	    "б": "#2eb286",
	    "в": "#74c600",
	    "г": "#38185f",
	...
	var pagesRules = exports.pagesRules = {
	    "а": 1,
	    "б": 9,
	    "в": 10,
	    "г": 5,
